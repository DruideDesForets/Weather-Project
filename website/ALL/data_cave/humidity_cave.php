...
$req_cave=$bdd->query('SELECT humidity, YEAR(date) AS year, MONTH(date) AS month, DAY(date) AS day, HOUR(date) AS hour, MINUTE(date) AS minute FROM cave');
...
echo '];';
    ...
    ?>
    Highcharts.chart('container_humidity_cave', {
        chart: {
            zoomType: 'x'
        },
        title: {
